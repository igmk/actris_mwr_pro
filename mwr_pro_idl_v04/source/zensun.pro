...
;    downloaded in Sept. 2009 from
;       http://www.astro.washington.edu/docs/idl/
;       http://www.astro.washington.edu/docs/idl/htmlhelp/slibrary01.html
;    even in 2012 this file has not changed...
;    a better documented algorithm can be found in
;     Reda and Andreas 2009:
